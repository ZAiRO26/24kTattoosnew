    ...
    <div className="pt-16 bg-minimal-white text-minimal-black min-h-screen">
      ...
      <section className="py-16 bg-minimal-light-gray">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center">
            <Link 
              to="/styles" 
              className="bg-minimal-black text-white px-8 py-4 font-medium hover:bg-minimal-dark-gray transition-colors duration-200 inline-block"
            >
              VIEW TATTOO STYLES
            </Link>
          </div>
      ...
      <section className="py-16 bg-minimal-white">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-lg text-minimal-gray leading-relaxed mb-8">
            At <strong className="text-minimal-black">24K Tattoo Hair & Oddities</strong>, every service is an experience designed to elevate your personal expression. We invite clients to relax, trust our expertise, and emerge transformed—not just in appearance, but in confidence and style.
          </p>
