...
const PiercingAftercarePage = () => (
  <div className="pt-16">
    <section className="relative py-20 bg-gray-900">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <h1 className="text-4xl md:text-6xl font-bold mb-6 gradient-text uppercase">Piercing Aftercare</h1>
        ...
        <p className="text-gray-400">For more information or questions about aftercare, please contact our studio or visit us in person.</p>
      </div>
    </section>
  </div>
);

export default PiercingAftercarePage;
